# Generated by Django 3.2.5 on 2021-07-05 19:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attention_line1', models.CharField(max_length=128)),
                ('attention_line2', models.CharField(max_length=128)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cross_references', models.ManyToManyField(blank=True, related_name='_landman_project_cross_references_+', to='landman.Project')),
        ...
        migrations.CreateModel(
            name='HistoricalJeffLegalHeader',
            fields=[
                ('id', models.BigIntegerField(auto_created=True, blank=True, db_index=True, verbose_name='ID')),
                ('acreage', models.DecimalField(blank=True, decimal_places=6, max_digits=13, null=True)),
                ('townshipNum', models.IntegerField()),
        ...
        migrations.AddField(
            ...
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='landman.subjecttype'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='agreement',
            name='related',
            field=models.ManyToManyField(blank=True, related_name='_landman_agreement_related_+', to='landman.Agreement'),
        ),
        migrations.AddField(
            model_name='agreement',
            name='rights',
